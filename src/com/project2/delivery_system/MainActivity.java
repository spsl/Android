...
public class MainActivity extends ListActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    List<FoodItem> values = datasource.getAllComments();
  ...
  public void onClick(View view) {
    ...
    case R.id.add:
      ...
      FoodItem = datasource.createFoodItem(comments[nextInt]);
      adapter.add(FoodItem);
      break;
    case R.id.delete:
      if (getListAdapter().getCount() > 0) {
        FoodItem = (FoodItem) getListAdapter().getItem(0);
        datasource.deleteComment(FoodItem);
        adapter.remove(FoodItem);
      }
      break;
    }
